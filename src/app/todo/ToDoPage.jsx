      ...
      <div className='px-6 pb-10 pt-6'>
        <div className='max-w-6xl mx-auto'>
          <div className='flex items-end justify-between gap-3 flex-wrap'>
            <h1 className='text-3xl md:text-4xl'>Todo List</h1>
          ...
          <section className='mt-6 grid gap-4 md:grid-cols-2'>
            {todos.map((todo, index) => (
              ...
              >
                <div className='flex items-center gap-3 font-archivoBlack'>
                  {/* icon */}
                  {todo.icon?.kind === "character" ? (
                    <Link
                      to={`/characters/${todo.icon?.id}`}
                  ...
                  <div className='flex-1 min-w-0'>
                    <div className='font-bold truncate'>
                      {todo.title ??
                        (todo.type === "character" ? "Character" : "Items")}
                    </div>
                    {todo.level ? (
            ...
            {summaryRows.length === 0 ? (
              <div className="">
                <p className='text-zinc-300 mt-2'>
                  Nothing in your todo list yet. Add something from the
                  calculator.
